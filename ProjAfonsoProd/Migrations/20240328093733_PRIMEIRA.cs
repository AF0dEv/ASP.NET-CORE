    ...
    public partial class PRIMEIRA : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Treunioes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Treunioes_Tclientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Tclientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Treunioes_Tfuncionarios_FuncionarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Treunioes_ClienteId",
                table: "Treunioes",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Treunioes_FuncionarioId",
                table: "Treunioes",
